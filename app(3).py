...
# The source module reads environment variables, so bridge the
# configured Streamlit secrets into os.environ at runtime.
try:
    for _secret_name in ("VIRUSTOTAL_API_KEY", "GROQ_API_KEY"):
